...
class MvHistory extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id_movement, id_locator, qty_mvnt, val_mvnt, qty_current, val_current', 'required'),
			array('id_movement, id_locator, create_by, update_by', 'numerical', 'integerOnly'=>true),
			...
			array('id_movement, id_locator, qty_mvnt, val_mvnt, qty_current, val_current, trans_type, trans_source, ref_number, update_date, create_by, update_by, create_date', 'safe', 'on'=>'search'),
		);
	}

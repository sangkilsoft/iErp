 ...
 * @property SalShipment[] $salShipments
 * @property SorderInfo $sorderInfo
 * @property SorderLine[] $sorderLines
 * @property SalInvoice[] $salInvoices
...
class SalOrder extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            array('so_num, id_orgn, id_branch, id_customer, id_price_cat, py_term, order_date, status', 'required'),
            array('id_orgn, id_branch, id_warehouse, id_customer, id_price_cat, py_term, create_by, update_by', 'numerical', 'integerOnly' => true),
            array('so_num', 'length', 'max' => 13),
            array('py_method', 'length', 'max' => 32),
            array('description', 'length', 'max' => 64),
            array('status', 'length', 'max' => 16),
            array('delivery_schdate', 'safe'),
            array('so_num','unique', 'on'=>'insert'),
            // The following rule is used by search().
            // Please remove those attributes that should not be searched.
            array('id_sorder, so_num, id_orgn, id_branch, id_warehouse, id_customer, py_method, id_price_cat, py_term, order_date, delivery_schdate, description, status, create_by, create_date, update_by, update_date', 'safe', 'on' => 'search'),
        );
    }
    ...
    public function relations() {
        ...
        return array(
            'salShipments' => array(self::HAS_MANY, 'SalShipment', 'id_sorder'),
            'sorderInfo' => array(self::HAS_ONE, 'SorderInfo', 'id_sorder'),
            'sorderLines' => array(self::HAS_MANY, 'SorderLine', 'id_sorder'),
            'salInvoices' => array(self::HAS_MANY, 'SalInvoice', 'id_sorder'),
            'idCustomer' => array(self::BELONGS_TO, 'Customers', 'id_customer'),
            'status_so' => array(self::BELONGS_TO, 'Configure', 'id_sorder'),
        );
    }
